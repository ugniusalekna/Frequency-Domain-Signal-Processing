...
def open_file():
    ...
    if file_path:
        ...
        # Apply window and truncate amplitude spectrum for more accurate visualization
        windowed_signal = apply_window(sample_rate, signal_data, num_of_channels, window_function='hanning')
